...
public class HashMapAccessKeyExample {
	...
	public void accessKeys() {
		...
		if (userCityMapping.containsKey(userName)) {
			...
			String city = userCityMapping.get(userName); // lấy giá trị
		...
		userCityMapping.put(userName, "California"); // ghì đè lên giá trị cũ
		...
		// the specified key was not found in the HashMap
