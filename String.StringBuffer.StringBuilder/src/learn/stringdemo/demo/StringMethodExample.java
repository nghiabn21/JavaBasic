...
public class StringMethodExample {
	...
	public void demonstrateStringMethod() {
		...
		System.out.println("SubString of targetString: " + targetString.substring(8)); // bứt đầu từ 0
		System.out.println("SubString of targetString: " + targetString.substring(8, 12)); // từ 1
		...
		char[] charArray = s2.toCharArray(); // ép kiểu string thành mảng
